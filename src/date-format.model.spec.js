...
describe('DateFormatModel', function () {
    ...
    describe('::subDate', function () {
        ...
        it('subtracts 38 days to date 1-1-1999', function () {
            ...
            var date = '1999-1-1T00:00:00-02:00';
            var result = model.subDate(date, date_format_enum_1.DateFormatEnum.DAY, 37, false);
            expect(result).toEqual(expected);
            date = '1999-1-1';
            result = model.subDate(date, date_format_enum_1.DateFormatEnum.DAY, 37, false);
            expect(result).toEqual(expected);
        });
    ...
    it('gets first date from month of 24/12/1994', function () {
        var expected = '1994-12-01T00:00:00-02:00';
